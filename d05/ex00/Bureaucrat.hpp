...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/01/14 11:16:45 by aachir            #+#    #+#             */
/*   Updated: 2019/01/15 11:46:33 by aachir           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//    Bureaucrat( void ); does not make sense since name is constant no way to set it later setName()...
    ...
    void upGrade( void );
    void upGrade( const int & nGrade );
    void downGrade( void );
    void downGrade( const int & nGrade );
